def force_based_placement(data, original_data=None, iterations=20, overlap_force=0.2, spring_force=0.05, halo_size=0):
    """
    ...
    # Run multiple iterations of force application
